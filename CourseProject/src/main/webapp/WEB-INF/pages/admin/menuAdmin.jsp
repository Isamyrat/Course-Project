...
<br>
<a href="/watchManagersAdmin?page=${0}&size=${5}" class="fancy-btn"><spring:message code="wMan"/></a>
<br>
<a href="/watchTeacher?page=${0}&size=${5}" class="fancy-btn"><spring:message code="wTeach"/></a>
<br>
