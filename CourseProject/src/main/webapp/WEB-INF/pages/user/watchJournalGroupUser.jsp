...
<header>
    <div class="localize">
        ...
        <h4><a href="/watchJournalGroupUser${groupNumber}/${pageNumber}/${pageSize}?lang=en" class="big-button"><spring:message code="app.en"/></a></h4>
        <h4><a href="/watchJournalGroupUser${groupNumber}/${pageNumber}/${pageSize}?lang=ru" class="big-button"><spring:message code="app.ru"/></a></h4>
    </div>
</header>
<body>
