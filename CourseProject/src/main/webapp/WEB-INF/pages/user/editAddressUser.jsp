...
<header>
    <div style="float: right">
        <h4><a href="/editAddressUser${addressId}?lang=en" style="color: white; font-size: 10px"><spring:message
                code="app.en"/></a></h4>
        <h4><a href="/editAddressUser${addressId}?lang=ru" style="color: white"><spring:message code="app.ru"/></a></h4>
    </div>
</header>
